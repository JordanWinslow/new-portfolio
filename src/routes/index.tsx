...
function Home() {
  ...
  useEffect(() => {
    if (!hasUnlockedPageAchievement.current) {
      // Unlock achievement for visiting home page
  ...
  const handleButtonClick = () => {
    // Unlock achievement for clicking the main button
    unlockAchievement('button_master')
  }
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black font-mohave">
      ...
      <div className="fixed inset-0 flex items-center justify-center z-20 w-full h-screen pointer-events-none">
        <div className="relative flex items-center justify-center pulse-fade-group opacity-0 animate-[fade-in_3s_ease-in-out_5s_forwards]">
